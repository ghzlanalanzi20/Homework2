...
Confirm that once you have filtered for these characteristics you are left with a data frame with 'nrow(nobel_living)' observations, once again using inline code.
...
```
Answer: yes , because in buzzfeed  we analyzing the data to search for more understanding the data and get information form it we go deep and deep and make a lot of filterations to understanding the data.
